...
require 'bitcoin'
require 'onchain/extensions/tx.rb'
require 'onchain/extensions/zcash_tx.rb'
require 'onchain/extensions/bitcoin_private_tx.rb'
require 'onchain/extensions/bitcoin_cash_tx.rb'
