...
describe OnChain do
  ...
  it "insite should give me the unspent outs" do
  ...
  it "insite should give me a history for an address" do
  ...
  it "insite should bring back a raw transaction in hex" do
  ...
  it "insite should broadcast a transaction" do
    
    VCR.use_cassette(the_subject) do
      @insight.send_tx('')
    end
  end
