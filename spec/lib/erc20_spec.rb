...
describe OnChain do
  ...
  it "should transfer a token." do
    ...
    VCR.use_cassette(the_subject) do
      ...
      expect(hex).to eq('0xf86a018504a817c800830186a0941175a66a5c3343bbf06aa818bb482ddec30858e080b844a9059cbb00000000000000000000000046fc2341dc457ba023cf6d60cb0729e5928a81e60000000000000000000000000000000000000000000000000de0b6b3a7640000808080')
  ...
  it "should finalize a token transfer." do
    ...
    VCR.use_cassette(the_subject) do
      ...
      expect(tx.hex).to eq('')
